...
public class BookService {
	...
	private final static String SERVER_URI = "http://localhost:8085";
	...
	public static Book getBook(int book_code) {
		Book emp = restTemplate.getForObject(SERVER_URI + BOOK_AND_ID, Book.class, book_code);
		return emp;
	}

	public static void addBook(Book book) {
		restTemplate.postForObject(SERVER_URI + BOOK, book, Book.class);
	}

	public static void updateBook(Book book) {
		String Url = SERVER_URI + BOOK + "/" + book.getBookCode();
	...
	public static void deleteBook(int bookCode) {
		restTemplate.delete(SERVER_URI + BOOK_AND_ID, bookCode);
	}
}
